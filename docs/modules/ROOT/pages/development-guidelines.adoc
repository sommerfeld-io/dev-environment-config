...
control more as "More Tests" #35A339
control acceptance as "Acceptance Tests" #35A339
control security as "Security Tests" #35A339
control performance as "Performance Tests" #35A339
